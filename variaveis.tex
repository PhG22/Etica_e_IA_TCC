...
\title{Ética e IA: A Dupla Ocultação do Trabalho e da Manipulação na Indústria dos Jogos} % Título do trabalho
\titleen{Ethics and AI: The Double Concealment of Labor and Manipulation in Dthe Game Industry} % Título traduzido para inglês
...
\PalavraChaveD{indústria dos jogos}%% Palavra-chave D
\PalavraChaveE{dark patterns}%% Palavra-chave E
...
\KeywordD{game industry}%% Keyword D
\KeywordE{dark patterns}%% Keyword E
